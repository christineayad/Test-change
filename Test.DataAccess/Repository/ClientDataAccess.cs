...
namespace Test.DataAccess.Repository
{
    public class ClientDataAccess : IClientDataAccess
    {
        ...
        public IEnumerable<ClientStatusVM> GetAllClient(int page , int size , string searchterm)
        {
            ...
            var clients = _dbContext.Clients.FromSqlRaw($"EXECUTE GetAllClients  @page, @size, @searchterm",
        pageParam, sizeParam, searchParam)
             .AsEnumerable()
